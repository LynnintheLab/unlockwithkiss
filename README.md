...
Myanmar controls and the personal note use the supplied Walone Regular and Thin fonts, served locally. The diary button opens the note with a slideshow before the Google Drive link. Both slideshows include 21 unique landscape photographs, with a soft crossfade every six seconds and no visible control bar or letterboxing. Hover pauses playback; keyboard users can focus the photo, press Space to pause/resume, or use the arrow keys to browse. Reduced-motion preferences disable autoplay and transitions. Web-sized slideshow copies are in `public/slideshow/`.
